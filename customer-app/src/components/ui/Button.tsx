...
import { BORDER_RADIUS_DEFAULT, CORNERS, FONT_SIZE_DEFAULT, HEIGHT, HEIGHT_DEFAULT } from '@/theme/globals';
...
export const Button = forwardRef<View, ButtonProps>(
  (
    ...
    const getButtonStyle = (): ViewStyle => {
      ...
      switch (size) {
        case 'sm':
          Object.assign(baseStyle, { height: HEIGHT.sm || 32, paddingHorizontal: 12 });
          break;
        case 'lg':
          Object.assign(baseStyle, { height: HEIGHT.lg || 52, paddingHorizontal: 36 });
          break;
        case 'icon':
          ...
          break;
        default:
          Object.assign(baseStyle, { height: HEIGHT_DEFAULT, paddingHorizontal: 32 });
      }
    ...
    const getPressableStyle = (): ViewStyle => {
      ...
      return flexValue === 1
        ...
        : flexValue !== null
          ? {
            flex: flexValue,
            maxHeight: size === 'sm' ? (HEIGHT.sm || 36) : size === 'lg' ? (HEIGHT.lg || 52) : HEIGHT_DEFAULT,
          }
          : {};
    };
      ...
      >
        <Animated.View style={[animatedStyle, buttonStyle, styleWithoutFlex]}>
          {loading ? (
            ...
            >
              {icon && (
                <Icon name={icon} color={iconColor || contentColor} size={iconSize} />
              )}
              {label ? (
                <Text style={[{ color: labelColor || contentColor }, finalTextStyle, textStyle]}>
                  {label}
                </Text>
              ) : (
                <Text style={[{ color: labelColor || contentColor }, finalTextStyle, textStyle]}>
