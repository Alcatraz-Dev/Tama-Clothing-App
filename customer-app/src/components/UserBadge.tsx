                ...
                <View style={styles.header}>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {t(
                          userProfile.role === "brand_owner"
                            ? "brandOwner"
                            : userProfile.role === "vendor_support"
                              ? "vendorSupport"
                              : userProfile.role?.toLowerCase() || "customer",
                        ).toUpperCase()}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={styles.infoWrapper}>
                    ...
                    >
                      ...
                      <Text
                        style={[
                          styles.verifiedText,
                          { color: isDark ? themeColor : themeColor + "CC" },
                        ]}
                        numberOfLines={1}
                      >
                        {t("verifiedFace")}
                ...
                <View style={styles.backHeader}>
                  ...
                  >
                    <View>
                      ...
                      >
                        #{userProfile.id.substring(0, 12).toUpperCase()}
                      </Text>
                    </View>
                    <View style={{ alignItems: "flex-end" }}>
                      <Image
                        source={APP_ICON_2}
                        style={styles.cornerLogoSmall}
                      />
                      <View
                        style={{
                          flexDirection: "row",
                  ...
                  <View
                    style={[styles.divider, { backgroundColor: themeColor }]}
                  />
                </View>
                ...
                <View style={styles.detailsSection}>
                  <View style={{ maxHeight: 100 }}>
                    <Text
                      ...
                      numberOfLines={4}
                    >
                      {getName(userProfile.bio) ||
                        t("noUserDescription") ||
                        "No description available for this user."}
                    </Text>
                  </View>
                  ...
                  <View
                    style={[
                      styles.statsGrid,
                      isVendorOrCollab() && { justifyContent: "center" },
                    ]}
                  >
                    {isVendorOrCollab() ? (
                      <>
                        ...
                        >
                          ...
                          >
                            {userProfile.worksCount
                              ? userProfile.worksCount.toLocaleString()
                              : "0"}
                          </Text>
                          <Text style={styles.statLabel}>
                            {t("products") || "PRODUCTS"}
                        ...
                        >
                          ...
                          >
                            {userProfile.friendsCount
                              ? userProfile.friendsCount.toLocaleString()
                              : "0"}
                          </Text>
                          <Text style={styles.statLabel}>
                            {t("friends") || "FRIENDS"}
