      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoSection}>
          <View style={styles.titleRow}>
            <Text
              variant="caption"
              style={{ color: textMutedColor, letterSpacing: 2 }}
            >
              BEY3A PREMIUM
            </Text>
            <View style={{ alignItems: "flex-end" }}>
              ...
              {product.discountPrice && Number(product.discountPrice) > 0 && (
                ...
                >
                  {String(parseFloat(String(product.price || 0)).toFixed(3))}{" "}
                  TND
                </Text>
              )}
            </View>
          ...
          >
            {product.description ||
              "Un vêtement d'exception conçu avec soin dans les ateliers Bey3a. Qualité premium et coupe intemporelle."}
          </Text>
