            ...
            {selectedApp.socialMedia && (
              <View style={styles.socialSection}>
                ...
                {selectedApp.socialMedia.instagram && (
                  <Text
                    style={[styles.socialText, { color: colors.foreground }]}
                  >
              ...
              <View style={styles.documentsSection}>
                ...
                {selectedApp.documents.businessLicense && (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setSelectedImage(
                        selectedApp.documents?.businessLicense || null,
                      )
                    }
                  >
                    ...
                    <View style={styles.documentInfo}>
                      ...
                      <Text style={[styles.documentHint, { color: accent }]}>
                        Tap to view
                      </Text>
                    </View>
                ...
                {selectedApp.documents.idCardFront && (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setSelectedImage(selectedApp.documents?.idCardFront || null)
                    }
                  >
                ...
                {selectedApp.documents.idCardBack && (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setSelectedImage(selectedApp.documents?.idCardBack || null)
                    }
                  >
                    <User size={24} color={accent} />
                    <View style={styles.documentInfo}>
                ...
                {selectedApp.documents.storeFront && (
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setSelectedImage(
                        selectedApp.documents?.storeFront || null,
                      )
                    }
                  >
            ...
            {selectedApp.paymentProof && (
              <View style={styles.documentsSection}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setSelectedImage(selectedApp.paymentProof || null)
                  }
                >
              ...
              >
                <View style={styles.appHeader}>
                  <View style={styles.appInfo}>
                    ...
                    <Text
                      style={[styles.appEmail, { color: colors.textMuted }]}
                    >
                      {app.businessEmail}
                    </Text>
                  </View>
                ...
                <View style={styles.appDetails}>
                  ...
                  <Text
                    style={[styles.appCategory, { color: colors.textMuted }]}
                  >
