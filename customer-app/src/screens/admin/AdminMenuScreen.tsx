...
export default function AdminMenuScreen({
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      icon: Package,
      route: "AdminProducts",
      roles: ["admin", "brand_owner", "nor_kam", "editor", "vendor"],
      color: "#FF2D55",
      feature: "products",
    },
    {
      ...
      icon: ShoppingCart,
      route: "AdminOrders",
      roles: ["admin", "support", "brand_owner", "nor_kam", "vendor"],
      color: "#34C759",
    },
    {
      label: t("brandRevenue"),
      icon: Ticket,
      route: "BrandRevenue",
      roles: ["admin", "brand_owner", "vendor"],
      color: "#EC4899",
      feature: "brandRevenue",
    },
    {
      label: t("clients"),
      icon: UsersIcon,
    ...
    },
    {
      label: t("flashSale"),
      icon: Zap,
      route: "AdminFlashSale",
      roles: ["admin", "brand_owner", "nor_kam", "editor", "vendor"],
      color: "#FFCC00",
      feature: "marketing",
    },
    {
      label: t("treasureHunt"),
      icon: Trophy,
      route: "AdminTreasureHunt",
      roles: ["admin", "brand_owner", "vendor"],
      color: "#FF6B6B",
      feature: "treasureHunt",
    },
    {
      label: t("promoBanners"),
      icon: Ticket,
      route: "AdminPromoBanners",
      roles: ["admin", "brand_owner", "nor_kam", "editor", "vendor"],
      color: "#EC4899",
      feature: "banners",
    },
    {
      label: t("ourSelection"),
      icon: ListTree,
      route: "AdminNotreSelection",
      roles: ["admin", "nor_kam", "editor"],
      color: "#10B981",
    },
    {
      label: t("support"),
      icon: MessageCircle,
      route: "AdminSupportList",
      roles: ["admin", "support", "vendor", "vendor_support"],
      color: colors.primary,
    },
    {
      label: t("liveStreaming"),
      icon: Video,
      route: "LiveAnalytics",
      roles: ["admin", "brand_owner", "vendor"],
      color: "#7C3AED",
    ...
    {
      label: t("vendorApplications"),
      icon: Store,
      route: "AdminVendorApplications",
      roles: ["admin"],
      color: colors.primary,
    },
    {
  ...
  const allVisibleItems = menuItems.filter((item) =>
          ...
          {allVisibleItems.map((item, index) => {
            ...
            return (
                    ...
                    Alert.alert(
                      ...
                      [
                        { text: t("cancel"), style: "cancel" },
                        {
                          ...
                          onPress: () => onNavigate("VendorRegistration"),
                        },
                      ],
                    );
                    return;
              ...
              >
                ...
                >
                  <View
                    style={[sc.iconBox, { backgroundColor: item.color + "15" }]}
                  >
