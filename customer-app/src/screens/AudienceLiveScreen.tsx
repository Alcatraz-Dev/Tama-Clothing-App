              ...
              {featuredProducts.length === 0 ? (
                <View style={{ alignItems: "center", padding: 50 }}>
                  ...
                  <Text style={{ color: "#888", marginTop: 12, fontSize: 14 }}>
                    {t("noProductsFeatured") || "No products featured yet."}
                  </Text>
                </View>
              ) : (
              ...
              {selectedProduct && (
                ...
                >
                      ...
                      {(() => {
                        ...
                        if (isActiveCoupon) {
                          ...
                          if (couponType === "free_shipping") {
                            ...
                            finalPrice =
                              basePrice * (1 - activeCoupon.discount / 100);
                          } else {
                            finalPrice = Math.max(
                              0,
                              basePrice - activeCoupon.discount,
                            );
                          }
                        }
                      ...
                      <View style={{ marginBottom: 20 }}>
                        ...
                        >
                          {selectedProduct.colors.map((c: string) => {
                            const colorHex = c.startsWith("#")
                              ? c
                              : COLOR_MAP[c.toUpperCase()] || "#CCCCCC";
                  ...
                  <View style={{ marginBottom: 14 }}>
                    ...
                    >
                      {t("contactNumber") || "NUMÉRO DE CONTACT"}
                    </Text>
                    <TextInput
                  ...
                  <View style={{ marginBottom: 14 }}>
                    ...
                    <TextInput
                      placeholder={
                        t("deliveryAddress") || "Chatt mariem, sousse"
                      }
                      placeholderTextColor="#555"
                      value={address}
      ...
      {isChatMuted && (
        ...
        >
          ...
          <Text style={{ color: "#fff", fontSize: 13, fontWeight: "700" }}>
            {t
              ? t("commentsMuted") || "Comments muted by host"
              : "Comments muted by host"}
          </Text>
        </Animatable.View>
      )}
      ...
      {isMyCommentsMuted && (
        ...
        >
          ...
          <Text style={{ color: "#fff", fontSize: 13, fontWeight: "800" }}>
            {t
              ? t("yourCommentsMuted") || "Your comments are muted by the host"
              : "Your comments are muted by the host"}
          </Text>
        </Animatable.View>
      )}
        ...
        >
          ...
          >
            {(() => {
              ...
              const giftObj = GIFTS.find(
                (g) => g.name === currentGift.giftName,
              );
              // Fallback for Stickers if not found in GIFTS
              const points =
                giftObj?.points || (currentGift.giftName === "Sticker" ? 1 : 0);
                ...
                <>
                    ...
                    <Image
                      source={
                        currentGift.senderAvatar
                          ? typeof currentGift.senderAvatar === "number"
                            ? currentGift.senderAvatar
                            : { uri: currentGift.senderAvatar }
                          : {
                  ...
                  >
                    <Animatable.Image
                      ...
                      duration={1000}
                      source={
                        typeof currentGift.icon === "number"
                          ? currentGift.icon
                          : { uri: currentGift.icon || "" }
                      }
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1, padding: 8, justifyContent: "center" }}>
                ...
                >
                  {t("limitedTimeOffer")?.toUpperCase() || "OFFRE LIMITÉE"}
                </Text>
                <Text
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() => {
                    if (Clipboard) {
                      ...
                      Alert.alert(
                        t("success") || "Succès",
                        t("couponCopied") || "Coupon copié",
                      );
                    } else {
                      Alert.alert(
                        t("couponCode") || "Code Coupon",
                        activeCoupon.code,
                      );
                    }
                  }}
                ...
                >
                  ...
                  >
                    <Text
                      style={{ color: "#000", fontWeight: "900", fontSize: 8 }}
                    >
                      {t("claimCoupon")?.toUpperCase() || "RÉCUPÉRER"}
                    </Text>
                  </LinearGradient>
                </TouchableOpacity>
              </View>
