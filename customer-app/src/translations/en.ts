export const en = {
  success: 'Success',
  home: 'HOME', shop: 'SHOP', bag: 'BAG', me: 'ME', feed: 'FEED', collab: 'COLLAB', noData: 'No data',
  ...
  productNameFr: 'PRODUCT NAME (FR)', productNameAr: 'PRODUCT NAME (AR)', productNameEn: 'PRODUCT NAME (EN)',
  ...
  frenchName: 'French Name', arabicName: 'Arabic Name', englishName: 'English Name',
  frenchDesc: 'French description...', arabicDesc: 'Arabic description...', englishDesc: 'English description...',
  brandOwner: 'BRAND OWNER', role: 'ROLE', admin: 'ADMIN', customer: 'CUSTOMER', driver: 'DRIVER',
  ...
  noReviews: 'No reviews yet.', ratings: 'Ratings', noPolicyDefined: 'No policy defined.',
  futureMinimalism: 'FUTURE MINIMALISM', premiumQuality: 'Premium quality clothing',
  noProductsInCategory: 'No products in this category yet.',
  appNotifications: 'APP NOTIFICATIONS', pushNotifications: 'Push Notifications',
  appVersion: 'App Version', soldOut: 'SOLD OUT', inStock: 'In Stock',
  support: 'Support', chatWithSupport: 'Chat with support', typeMessage: 'Type your message...',
  startConversation: 'Start a conversation with our team',
  logoutConfirmTitle: 'Logout', logoutConfirmMessage: 'Are you sure you want to log out?',
  orderTotal: 'ORDER TOTAL', clientInfo: 'CLIENT INFO', orderItems: 'ITEMS',
  updateStatus: 'UPDATE STATUS', tapToChangeStatus: 'TAP TO CHANGE',
  deliveryAddress: 'DELIVERY ADDRESS', contactInfo: 'CONTACT', paymentMethod: 'PAYMENT METHOD',
  ...
  start: 'START',
  receiver: 'RECEIVER',
  noDeliveries: 'No assigned deliveries',
  noAssignedShipmentsIn: 'No assigned shipments in {{city}}',
  deliveryStarted: 'Delivery started! Tracking is live.',
  map: 'MAP',
};
