export const fr = {
  ...
  statusShipped: 'EXPÉDIÉ', statusInTransit: 'EN TRANSIT', statusOutForDelivery: 'EN COURS DE LIVRAISON', statusCancelled: 'ANNULÉ', statusProcessing: 'EN COURS', reviewSubmitted: 'Avis envoyé !',
