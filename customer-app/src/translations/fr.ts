export const fr = {
  home: 'ACCUEIL', shop: 'SHOP', bag: 'PANIER', me: 'MOI', feed: 'FIL', collab: 'COLLAB', noData: 'Aucune donnée',
  ...
  officialPartner: 'PARTENAIRE OFFICIEL', shopCollection: 'COLLECTION SHOP', follow: 'SUIVRE', unfollow: 'NE PLUS SUIVRE', rating: 'ÉVALUATION', followers: 'ABONNÉS', connect: 'RÉSEAUX', socialMedia: 'RÉSEAUX SOCIAUX', viewAllCollection: 'VOIR TOUTE LA COLLECTION', allProducts: 'Tous les produits',
  noProducts: 'Aucun produit',
  global: 'GLOBAL',
  nearMe: 'PROCHE DE MOI',
  noProductsAvailable: 'Aucun produit disponible.', partner: 'PARTENAIRE', checkOut: 'Découvrez', leaveReview: 'LAISSER UN AVIS', website: 'SITE WEB',
  projects: 'PROJETS',
  ...
  productNameFr: 'NOM PRODUIT (FR)', productNameAr: 'NOM PRODUIT (AR)', productNameEn: 'NOM PRODUIT (EN)',
  ...
  productDescFr: 'DESCRIPTION (FR)', productDescAr: 'DESCRIPTION (AR)', productDescEn: 'DESCRIPTION (EN)',
  images: 'IMAGES', duplicateColor: 'Cette couleur est déjà ajoutée',
  frenchName: 'Nom en français', arabicName: 'Nom en arabe', englishName: 'Nom en anglais',
  frenchDesc: 'Description en français...', arabicDesc: 'Description en arabe...', englishDesc: 'Description en anglais...',
  brandOwner: 'RESPONSABLE MARQUE', role: 'RÔLE', admin: 'ADMIN', customer: 'CLIENT', driver: 'LIVREUR',
  ...
  liveNow: 'EN DIRECT', enDirect: 'EN DIRECT', viewers: 'spectateurs', flammes: 'Flammes', joinNow: 'Rejoindre maintenant', join: 'REJOINDRE',
  broadcaster: 'DIFFUSEUR',
  shopNow: 'ACHETER MAINTENANT',
  startLive: 'DÉMARRER LE LIVE', joinLive: 'REJOINDRE LE LIVE',
  hostIsLive: 'est en direct !',
  login: 'Connexion', signup: 'Inscription', email: 'E-mail', password: 'Mot de passe', welcomeBack: 'Bienvenue sur',
  ...
  createAccount: 'Créer un Compte sur', searchCollections: 'RECHERCHER...', all: 'TOUT',
  ...
  error: 'ERREUR', failedDeleteShipment: 'Échec de la suppression de l\'expédition', na: 'N/A', save: 'SAUVEGARDER', delete: 'SUPPRIMER', confirmDelete: 'CONFIRMER SUPPRESSION', areYouSure: 'Êtes-vous sûr ?',
  ...
  coupons: 'COUPONS', couponCode: 'CODE PROMO', discount: 'REMISE', orderAccepted: 'Commande Acceptée !',
  ...
  lastUpdate: 'DERNIÈRE MISE À JOUR', courier: 'TRANSPORTEUR', proofOfDelivery: 'PREUVE DE LIVRAISON',
  rateYourDelivery: 'NOTEZ VOTRE LIVRAISON', thankYouFeedback: 'Merci pour votre retour !',
  ...
  analyticsSummaryDescription: 'Aperçu complet des performances de votre diffusion et de l\'engagement de l\'audience.',
  ...
  marketplaceDesc: 'Explorez des milliers de produits auprès de vendeurs locaux',
  ...
  no_shipment_desc: "Nous n'avons pas trouvé de shipment avec cet ID. Veuillez vérifier le numéro de suivi et réessayer.",
  go_back: 'Retour',
  ...
  cameraPermissionMsg: 'Nous avons besoin de votre permission pour afficher la caméra',
  ...
  mediaPermissionMessage: "Veuillez autoriser l'accès à votre bibliothèque photo dans les paramètres.",
  ...
  confirmDeleteOrder: 'Êtes-vous sûr de vouloir supprimer cette commande de votre historique ?',
  ...
  ultimateDesc: 'Puissance maximale et personnalisation pour les grandes entreprises',
  ...
  kycDocumentsDesc: 'Téléchargez votre carte d\'identité (recto-verso) pour vérification',
  ...
  and: 'et',
  vendorApplicationSubmitted: 'Votre demande de vendeur a été soumise ! Nous la examinerons sous 2-3 jours ouvrables.',
  ...
  treasureHuntScanNow: 'Scanner Maintenant',
  ...
  treasureHuntClaimRewardConfirm: 'Voulez-vous réclamER cette récompense maintenant?',
  ...
  treasureHuntExploreMapDesc: 'Voir tous les emplacements des trésors sur la carte',
  treasureHuntFindTreasures: 'Trouver les Trésors',
  treasureHuntFindTreasuresDesc: 'Visitez les emplacements et scannez les codes QR',
  treasureHuntWinRewards: 'Gagner des Récompenses',
  treasureHuntWinRewardsDesc: 'Collectez des récompenses pour chaque découverte',
  ...
  treasureHuntNewLocation: 'Nouvel Emplacement',
  treasureHuntEditLocation: 'Modifier l\'Emplacement',
  ...
  treasureHuntErrorSaving: 'Erreur lors de l\'enregistrement. Veuillez réessayer.',
  ...
  treasureHuntErrorDeleting: 'Erreur lors de la suppression. Veuillez réessayer.',
  ...
  treasureHuntLocationCreated: 'Emplacement créé avec succès!',
  treasureHuntLocationUpdated: 'Emplacement mis à jour avec succès!',
  treasureHuntLocationDeleted: 'Emplacement supprimé avec succès!',
  treasureHuntNoLocations: 'Pas d\'Emplacements',
  treasureHuntAddFirstLocation: 'Ajoutez votre premier emplacement',
  treasureHuntDeleteConfirm: 'Êtes-vous sûr de vouloir supprimer ceci?',
  treasureHuntDeleteLocationConfirm: 'Êtes-vous sûr de vouloir supprimer cet emplacement?',
  treasureHuntSelectCampaign: 'Sélectionnez une campagne pour gérer les emplacements',
  ...
  treasureHuntLocationNameFrPlaceholder: 'Nom de l\'emplacement en français',
  treasureHuntLocationNameArPlaceholder: 'Nom de l\'emplacement en arabe',
  ...
  treasureHuntAway: 'loin',
  treasureHuntNavigate: 'Aller',
  treasureHuntAlmostThere: 'Presque là!',
  treasureHuntDiscoveryOrder: 'Ordre de Découverte',
  treasureHuntDiscoveryAny: 'Ordre Libre',
  treasureHuntDiscoverySequential: 'Séquentiel',
  treasureHuntSpecialNone: 'Aucun',
  treasureHuntSpecialFirst: 'Premier Trouveur',
  treasureHuntSpecialTop3: 'Top 3 Trouveurs',
  treasureHuntSpecialTop10: 'Top 10 Trouveurs',
  treasureHuntBonusRewards: 'Bonus pour les Meilleurs',
